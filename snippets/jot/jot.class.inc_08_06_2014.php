...
class CJot {
	...
	function Run() {
		...
		$this->config["subject"]["subscribe"] = !is_null($this->Get("subjectSubscribe")) ? $this->Get("subjectSubscribe") : "Добавлен новый ответ в тему, которую вы смотрели";
		$this->config["subject"]["moderate"] = !is_null($this->Get("subjectModerate")) ? $this->Get("subjectModerate") : "Добавлен новый ответ в тему, которую вы моделируете";
		$this->config["subject"]["author"] = !is_null($this->Get("subjectAuthor")) ? $this->Get("subjectAuthor") : "Новый комментарий в вашем топике";
		...
		$this->config["validate"] = !is_null($this->Get("validate")) ? $this->Get("validate") : "content:Вы забыли написать комментарий.";
